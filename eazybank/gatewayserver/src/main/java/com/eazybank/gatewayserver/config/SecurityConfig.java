...
public class SecurityConfig {
    ...
    @Bean
    public SecurityWebFilterChain springFilterchain(ServerHttpSecurity  serverHttpSecurity){
        serverHttpSecurity.authorizeExchange(exchange->exchange.pathMatchers(HttpMethod.GET).permitAll()
                ...
                .pathMatchers("eazbank/loans/**").authenticated()
                .pathMatchers("eazbank/cards/**").authenticated())
